...
import type { Task, ProjectVisibility } from '@ganttlet/shared'
...
export default function App() {
  ...
  useProjectSync(serverProjectId, tasks, appSettings)
  ...
  }, [isFormOpen, isSettingsOpen, isAuthOpen, isShareOpen, isPrivacyOpen, isTermsOpen])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-3 items-center">
            <Toolbar
              ...
              isLoggedIn={backendAvailable && !!user}
      ...
      {isShareOpen && activeProject && (
        <ShareModal
          projectId={serverProjectId ?? activeProjectId}
          projectName={activeProject.name}
          visibility={visibility}
          onClose={() => setIsShareOpen(false)}
          onVisibilityChange={(v: ProjectVisibility) => setVisibility(v)}
        />
      )}
