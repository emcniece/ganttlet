...
import type { Task } from '@ganttlet/shared'
...
export function Toolbar({ tasks, onImport, chartRef, chartReady, googleClientId, onOpenSettings, onImportSheet, isLoggedIn, onShare }: ToolbarProps) {
